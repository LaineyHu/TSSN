    ...
    def __init__(self, growRate0, growRate, nConvLayers, kSize=3):
        ...
        for i in range(self.C):
            ...
            if i == 0:
                ...
                unit = nn.Sequential(*[SELayer(nChannels), RDB_Conv(nChannels, G)])
        ...
        self.LFF = nn.Sequential(*[SELayer(self.nOutChannels), nn.Conv2d(self.nOutChannels, G0, 1, padding=0, stride=1)])

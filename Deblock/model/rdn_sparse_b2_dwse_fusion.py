...
class RDB_Conv(nn.Module):
    def __init__(self, inChannels, growRate, groups=1, kSize=3):
        ...
        if (groups == 1):
            ...
            self.conv = nn.Sequential(*[
                nn.Conv2d(Cin, Cin, kSize, padding=(kSize-1)//2, stride=1, groups=groups),
                nn.Conv2d(Cin, G, 1, padding=0, stride=1),
                nn.ReLU()
            ])
    ...
    def __init__(self, growRate0, growRate, nConvLayers, kSize=3):
        ...
        for i in range(self.C):
            ...
            if (i%2 == 1):
                ...
                unit = RDB_Conv(nChannels, G, groups=nChannels)

...
# python main.py --scale 1 --save colornoise_restore_x50 --model tssn_ir --pre_train ../experiment/colornoise_x50/model/model_best.pt --epochs 1000 --batch_size 16 --patch_size 48 --resume 0 --lr_decay 200 --data_test Kodak24 --loss "1*L1_softmax" --GPU_id "0"

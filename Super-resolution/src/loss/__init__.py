...
from .ge_module import GELayer
from .ge_module import L1_softmax_layer
...
class Loss(nn.modules.loss._Loss):
    ...
    def forward(self, sr, hr):
        ...
        for i, l in enumerate(self.loss):
            if l['function'] is not None:
                if self.loss_type == 'GE_l1' or self.loss_type == 'L1_softmax':
                    loss = l['function'][0](sr, hr)
                    loss = l['function'][1](loss).mean()
                else:

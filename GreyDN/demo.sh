...
python main.py --scale 1 --save greynoise_x70 --model tsrn_ir --data_test Kodak24 --pre_train ../experiment/greynoise_x70/model/model_best.pt --test_only --GPU_id "0" --degree 70 --batch_size 1 --n_colors 1
